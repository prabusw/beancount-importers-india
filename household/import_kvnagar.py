...
from importers.aniruth import purse
...
importers = [
    ...
    icici.IciciBankImporter("Assets:IciciBank:Prabu","614901501585"),
    purse.AniruthPurseImporter("Assets:Household:Cash:Aniruth"),
]
